...
const AdminPage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Main Fixed Layout */}
      <div className="fixed inset-0 bg-[#F6F5F1] text-[#5f3c2c] font-serif pt-16 sm:pt-20 flex flex-col lg:flex-row overflow-hidden">

        {/* Sidebar */}
        <aside className="w-full lg:w-64 xl:w-72 bg-[#F6F5F1] border-t lg:border-t-0 lg:border-r border-[#e2cbb5] 
                          lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] z-20 overflow-x-auto lg:overflow-y-auto">
        ...
        <main className="flex-1 px-3 sm:px-4 lg:px-6 pb-6 sm:pb-8 h-[calc(100vh-4rem)] overflow-y-auto">
