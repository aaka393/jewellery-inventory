...
const Footer: React.FC = () => {
  return (
    <footer className="text-[#4F3C2A] font-light bg-[#F2ECE4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full max-w-6xl text-center">
            ...
            {/* Company Info */}
            <div>
              <h3 className="text-lg sm:text-xl font-serif italic font-medium mb-3">
                {SITE_CONFIG.name}
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li>
                  <Link to="/about" className="hover:text-[#aa732f] font-semibold transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:text-[#aa732f] font-semibold transition-colors">
                    Contact Us
                  </Link>
                </li>
                <li>
                  <Link to="/stores" className="hover:text-[#aa732f] font-semibold transition-colors">
                    FAQ
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="space-y-2 font-semibold text-xs sm:text-sm">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#aa732f] mt-8 pt-5 flex flex-col sm:flex-row justify-between items-center text-xs space-y-4 sm:space-y-0">
