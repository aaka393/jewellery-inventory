    ...
    <footer className=" text-[#aa732f] font-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          {/* Company Info */}
          <div>
            <h3 className="text-xl sm:text-2xl font-serif italic font-medium text-[#aa732f] mb-3 sm:mb-4">{SITE_CONFIG.name}</h3>
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a href={SITE_CONFIG.social.facebook} target="_blank" rel="noopener noreferrer">
                <Facebook className="h-4 w-4 sm:h-5 sm:w-5 text-[#aa732f] font-semibold hover:text-[#F2E9D8] transition-colors" />
              </a>
              <a href={SITE_CONFIG.social.instagram} target="_blank" rel="noopener noreferrer">
                <Instagram className="h-4 w-4 sm:h-5 sm:w-5 text-[#aa732f] font-semibold hover:text-[#F2E9D8] transition-colors" />
              </a>
              <a href={SITE_CONFIG.social.twitter} target="_blank" rel="noopener noreferrer">
                <Twitter className="h-4 w-4 sm:h-5 sm:w-5 text-[#aa732f] font-semibold hover:text-[#F2E9D8] transition-colors" />
              </a>
              <a href={SITE_CONFIG.social.youtube} target="_blank" rel="noopener noreferrer">
                <Youtube className="h-4 w-4 sm:h-5 sm:w-5 text-[#aa732f] font-semibold hover:text-[#F2E9D8] transition-colors" />
              </a>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-base sm:text-lg font-serif italic font-semibold text-[#aa732f] mb-3 sm:mb-4">Quick Links</h4>
          ...
          {/* Customer Care */}
          <div>
            <h4 className="text-base sm:text-lg font-serif italic font-semibold text-[#aa732f] mb-3 sm:mb-4">Customer Care</h4>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-base sm:text-lg font-serif italic font-semibold text-[#aa732f] mb-3 sm:mb-4">Contact Info</h4>
        ...
        <div className="border-t border-[#aa732f] font-semibold mt-12 sm:mt-16 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center text-xs space-y-4 sm:space-y-0">
          <p className="text-[#41382a] text-center sm:text-left">© 2024 {SITE_CONFIG.name}. All rights reserved.</p>
